...
require('connection/connection.php');
			...
			<div class="row">
				<div class="col-md-4">
					<div class="counter-area-content">
						<h2>Have <span>25 Years</span> of Experience</h2>
						<p>These days are all share them with me oh baby said inspect Californy till the one of when the lady to the hood.</p>
	...
	<!-- End Our Team Area -->
	<!-- Start Faq Area -->
	<section class="faq-area pt-100 pb-100 section-bg">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="section-title text-center mb-50">
			...
			<div class="row">
				<div class="col-lg-10 offset-lg-1">
					<div class="faq-area-full">
						<div class="accordion" id="accordionExample">

						  	<div class="accordion-item">
						    	<h2 class="accordion-header" id="headingOne">
						    		<span class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">When to consult for our services? </span>
						    	</h2>
						  	...
						  	<div class="accordion-item">
						    	<h2 class="accordion-header" id="headingTwo">
						      		<span class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Ways we can architect our company? </span>
						    	</h2>
						  	...
						  	<div class="accordion-item">
						    	<h2 class="accordion-header" id="headingThree">
						      		<span class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapsethree" aria-expanded="false" aria-controls="collapsethree">Do I have to commit to a contract? </span>
						    	</h2>
						  	...
						  	<div class="accordion-item">
						    	<h2 class="accordion-header" id="headingfour">
						      		<span class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapsefour" aria-expanded="false" aria-controls="collapsefour">When to consult for our services? </span>
						    	</h2>
						  	...
						  	<div class="accordion-item">
						    	<h2 class="accordion-header" id="headingfive">
						      		<span class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapsefive" aria-expanded="false" aria-controls="collapsefive">Any contracts or commitments? </span>
						    	</h2>
