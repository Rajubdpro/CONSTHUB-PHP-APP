		...
		'use strict';
			...
			var adminpopular = function(){
				...
				var sparklineLogin = function () {
					...
					$('#sparklinedash-widget-1').sparkline([0, 5, 6, 10, 9, 12, 4, 9], {
						type: 'bar',
						height: '30',
						barWidth: '4',
						resize: true,
					...
					$('#sparklinedash-widget-2').sparkline([0, 5, 6, 10, 9, 12, 4, 9], {
						type: 'bar',
						height: '30',
						barWidth: '4',
						resize: true,
					...
					$('#sparklinedash-widget-3').sparkline([0, 5, 6, 10, 9, 12, 4, 9], {
						type: 'bar',
						height: '30',
						barWidth: '4',
						resize: true,
					...
					$('#sparklinedash-widget-4').sparkline([0, 5, 6, 10, 9, 12, 4, 9], {
						type: 'bar',
						height: '30',
						barWidth: '4',
						resize: true,
